...
func main() {
	...
	serv := flag.Bool("server", false, "run the web application on port 7654")
	port := flag.String("port", "7654", "port for the http server to listen on (default: 7654)")
